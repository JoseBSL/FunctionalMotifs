...
cite complexheatmap https://doi.org/10.1093/bioinformatics/btw313
...
long_plants_1$Functional_groups[long_plants_1$Functional_groups==1] <- "Short-lived selfers" 
...
long_plants_1$Functional_groups <- factor(long_plants_1$Functional_groups, levels=c("Short-lived selfers",
