...
Understanding the global patterns of network structure is key to unravel the processes that govern community dynamics [@bascompte2007; @bastolla2009; @guimaraes2020]. However, common analytical approaches are unable to capture the full complexity of ecological systems. By analysing over- and under-representation of network motifs with a comprehensive dataset of real plant-pollinator networks we have shown that motifs are consistently over- and under-represented indicating the lack of randomness of the patterns of interactions at the meso-scale. This has direct implications with 
