...
From a pollinator perpective, we found that generalist network motifs were consistently over-represented (**Figure 2**). For instance, when we compare motifs with equal structure but inverted, we found that floral visitors had always over-representation in the positions that implied the highest number of links. Despite this is in good agreement with the current view of the generalist tendency of pollinators [@waser1996; @olesen2002; @ollerton2017], we found that this over-representation of the generalist network motifs was largely driven by the functional group of bees (e.g., positions 42, 46, 16, 4, 14 and 35 in motifs 15, 17, 7, 2, 6 and 13, respectively; see **Figure 3** for positions and **Figure 4** for motifs) while the rest of the groups tended to be under-represented in these generalist motifs and over-represented in motif positions with specialist roles (e.g., positions 11, 21, 28 and 34 in motifs 5, 9, 11 and 13, respectively; see **Figure 3** for positions and **Figure 4** for motifs). This large effect of bees on the overall patterns, are no surprise as bees were the functional group with largest number of interaction records in the whole set of networks as also recorded for other broad scale plant-pollinator network studies [@ollerton2017; MORE REFS?]. Unlike floral visitors, plant functional groups showed little differences between their maximum and minimum percentile on the different motif positions in the comparison with simulated networks, and thus similar probability of appearing on them (**Figures 3** and **4**).  However, the groups that involved higher levels of outcrossing showed a tendency to be more over-represented and probable on the different motif positions. For instance, the group of self incompatible perennials with large flowers, one of the groups that is expected to have higher levels of outcrossing rate [@goodwillie2010], showed the highest over-representation of all plant functional groups (**Figure 3**); and the group of tall plants with unisexual flowers, the one that is expected to have the highest levels of pollination contribution to reproduction [@rodger2021] was the most probable on the generalist motif for plant positions. 
...
In accordance with the findings of network motif patterns, we found higher representation of plant and pollinator functional groups in more densely connected motifs in contrast to the less densely connected ones (i.e., core-peripheral). As expected, the functional group of bees (the one with the highest number of qualitative interactions) was the most abundant in the different network motif positions. This concurs well with other plant-pollinator network studies where bees are the main functional group visiting flowers [@ollerton2017]. Interestingly, bees were highly over-represented in fan motif positions 4, 16 and 46 (**Figure 3**) which are associated with the highest levels of generalism. Further, this generalist tendency was also observed at motif level (e.g., **Figure 2** comparison of the percentiles of mirror image motifs that involve the opposed roles of specialization and generalism from a pollinator perpective). Despite this is in good agreement with the current view of the generalist nature of pollinators [@waser1996; @olesen2002], we found that this over-representation of the generalist network motifs was mainly driven by bees while the rest of functional groups tended to be under-represented in these generalist motifs. Unlike floral visitors, plant functional groups showed little differences between their maximum and minimum percentile on the different motif positions in the comparison with simulated networks, and thus similar probability of appearing on them. However, the groups that involved higher levels of outcrossing with perennial lifespan showed a tendency to be more over-represented and probable on the different motif positions. For instance, the group of self incompatible perennials with large flowers, one of the groups that is expected to have higher levels of outcrossing rate [@goodwillie2010], showed the highest over-representation of all plant functional groups on the different motif positions (**Figure 3**).

The observed functional group probabilities on the different motif positions (**Figure 4**) were insufficient to predict most of the observed network motifs (**Figure 5**). This implies that not just the structure of network motifs but also the identity of the elements of their structure are influenced by ecological processes that determine under- and over-representation of the different motif combinations. In addition, we found that just 30% of the possible 5,3250 motif combinations took place. However, this restricted set of possible combinations is no surprise, because plant-pollinator networks (i.e., full network level) have a high percentage of non-realized interactions [@bascompte2013]. Some of this non-observed motif combinations are likely to be the cause of under-sampling [@olesen2011; @jordano2016]. However, a large portion of the possible interactions do not take place because of life history constraints [i.e., forbidden links; @olesen2011; @bartomeus2016; @jordano2016]. Thus, similarly to the presence of forbidden links at the network level, we found also the existence of forbidden motifs that represent set of indirect interactions that do not take place in natural systems.
