...
To investigate the structure of the meso-scale in plant-pollinator networks, we gathered published plant-pollinator networks with worldwide distribution. Then, we classified the plant and floral visitor species from these networks into groups that summarize their main life-history strategies. After, we calculated the normalized motif frequencies and investigated if these frequencies are similar or not to the ones expected by chance with the help of null models. Then, for each group of plants and floral visitors we also calculated the normalized group frequency in the different motif positions and investigated their overall representation by comparing these observed frequencies with their simulated counterparts. Finally, we compared if there are differences in the observed frequencies of motif combinations in empirical networks and the expected frequencies of motif combinations calculated as the product of the probabilities of the different plant and floral visitor groups within the motif. 
