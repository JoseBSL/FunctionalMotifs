...
```{r, echo=FALSE, message=FALSE, cache=FALSE,  warning=FALSE, fig.cap="Figure 1. Adapted figure of Simmons et al., 2019 with all the possible motifs from two to five species in bipartite networks", fig.width=10,fig.height=8}
library(tidyverse)
...
ggplot(NULL) + 
  ...
  geom_point(data = motif_means,aes(y = as.factor(motif), x=mean), 
                size=2)+
  labs(y="Motif", x = "Percentile",colour="Motif classification")+
  theme_bw()
