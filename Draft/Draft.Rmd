...
The hierarchical cluster analysis divided the dataset with 1506 species and 15 traits into five different clusters with different and overlapping characteristics (Figure S1). The subset of plant species used in this study were distributed evenly across these different five groups (see Figure S1). The first cluster [...]
