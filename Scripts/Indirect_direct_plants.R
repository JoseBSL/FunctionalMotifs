...
#Check pol levels
levels(factor(plant_means_reordered$Node_FG))
...
one$ind_same_type_over_directed_int <- as.factor(one$ind_same_type_over_directed_int)
one_plot <- ggplot(one,aes(position,mean_natural_units))+
  geom_col(position = "dodge")+
  facet_grid(.~ind_same_type_over_directed_int,scale='free_x', space = "free_x") + ggtitle("Selfing herbs")+
...
two$ind_same_type_over_directed_int <- as.factor(two$ind_same_type_over_directed_int)
two_plot <- ggplot(two,aes(position,mean_natural_units))+
  geom_col(position = "dodge")+
  facet_grid(.~ind_same_type_over_directed_int,scale='free_x', space = "free_x") + ggtitle("Small outcrossing perennials")+
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())+
  ylab("Frequency")
...
three$ind_same_type_over_directed_int <- as.factor(three$ind_same_type_over_directed_int)
three_plot <- ggplot(three,aes(position,mean_natural_units))+
  geom_col(position = "dodge")+
  facet_grid(.~ind_same_type_over_directed_int,scale='free_x', space = "free_x") + ggtitle("Self-incomp. perennials with large flowers") +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())+
  ylab("Frequency")
...
four$ind_same_type_over_directed_int <- as.factor(four$ind_same_type_over_directed_int)
four_plot <- ggplot(four,aes(position,mean_natural_units))+
  geom_col(position = "dodge")+
  facet_grid(.~ind_same_type_over_directed_int,scale='free_x', space = "free_x") + ggtitle("Tall plants with small unisexual flowers") +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())+
  ylab("Frequency")
...
five$ind_same_type_over_directed_int <- as.factor(five$ind_same_type_over_directed_int)
five_plot <- ggplot(five,aes(position,mean_natural_units))+
  geom_col(position = "dodge")+
  facet_grid(.~ind_same_type_over_directed_int,scale='free_x', space = "free_x") + ggtitle("Short-lived outcrossers with long zygomorphic flowers")+
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())+
  ylab("Frequency")
...
library(patchwork)
one_plot / two_plot / three_plot / four_plot / five_plot 
