...
pollinators_sp_plot <- visreg(model_freq_specif_ind, "Indirect_interactions", by="Group",line.par = list(col = 'black'),
                         strip.names=c("Bee",
                                       "Coleoptera",
                                       "Lepidoptera",
                                       "Non-bee-Hymenoptera",
  ...
  xlab("Number of indirect interactions") + ylab("Partial residuals \n for percentile")+
...
plants_sp_plot <- visreg(model_freq_specif_ind_plant, "Indirect_interactions",line.par = list(col = 'black'), by="Group",
