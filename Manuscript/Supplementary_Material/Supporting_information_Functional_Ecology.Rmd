...
```{r, echo=FALSE, message=FALSE, cache=FALSE,  warning=FALSE,fig.align="center", fig.width=14,fig.height=7, out.width='100%',  fig.cap="\\textbf{Figure S6.} Association between the percentile and specialization of the different plant and floral visitor groups on motif positions"}
...
pollinators_sp_plot <- visreg(model_freq_specif_ind, "Specificity",scale="response", by="Group",line.par = list(col = 'black'),points=list(size=0),
  ...
  scale_x_continuous(breaks = seq(0, 1, by = 0.5))+ scale_fill_grey(start=0.5, end=0.8) +
   theme(strip.text.x = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 23))+
    ggtitle("Floral visitors")+ylim(-0.15,1)+geom_point(data=pollinator_freq_position_s_ind, aes(Specificity,Percentil), alpha=0.5)
...
plants_sp_plot <- visreg(model_freq_specif_ind_plant, "Specificity",line.par = list(col = 'black'), by="Group",scale="response",points=list(size=0),
  ...
  scale_x_continuous(breaks = seq(0, 1, by = 0.5))+
   theme(strip.text.x = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 23))+
  ggtitle("Plants")+ylim(-0.15,1)+geom_point(data=plant_freq_position_s_ind, aes(Specificity,Percentil), alpha=0.5)
...
```{r, echo=FALSE, message=FALSE, cache=FALSE,  warning=FALSE,fig.align="center", fig.width=14,fig.height=7, out.width='100%', fig.cap="\\textbf{Figure S7.} Association between the percentile and number of indirect interactions of the different plant and floral visitor groups on motif positions"}
