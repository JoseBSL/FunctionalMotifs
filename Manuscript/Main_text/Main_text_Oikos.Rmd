...
Here, we used 60 empirical networks from 18 different studies and 14 countries to evaluate the structure of the meso-scale in plant-pollinator networks. From these networks we extracted plant and floral visitors species and determined the principal groups that define their main life-history strategies.

, and for the plant and floral visitor species of these networks we determined 

for their plants and floral visitors we determined functional and taxonomic groups that summarize their main life-history strategies.


alongside functional groups of plants and taxonomic groups of floral visitors based on functional traits and taxonomic rank, respectively. To obtain plant functional groups, we used a comprehensive dataset that included floral, reproductive and vegetative traits compiled in a larger set of plant species. Floral visitor groups were divided by the main taxonomic groups that differed in life form and behaviour. Once we split the different plant-pollinator networks into their motif elements, we explored: (i) if there is a common invariant structural property in the overall motif networks (i.e., over- and under-represented motifs); (ii) which plant and floral visitor groups are over- and under-represented in different motif positions associated with specific ecological roles; and, (iii) if there are over- and under-represented plant and floral visitor group combinations within a motif. 

# Methods

**Overview**

To investigate the structure of the meso-scale in plant-pollinator networks, we have gathered 60 published plant-pollinator networks with worldwide distribution. Then, we have divided the plant and floral visitor species from these networks into groups that summarize their main life-history strategies. After, we have calculated the normalize motif frequencies and investigated if these frequencies are similar or not to the ones expected by chance with th help of null models. Then, we have also calculated the normalize group frequencies of plant and floral visitor for the different motif positions and investigated their overall representation and ecological implications by comparing the observed group frequencies on the different motif positions with simulated ones. Finally, we have tried to recover the observed motif combinations in empirical networks from their expected probability by assuming non-independence with the help of a simulation approach and z-scores.
...
For both floral visitor and plant groups we found different frequencies on motif positions that implied different ecological roles. First, for floral visitors, we found that bees had a tendency to appear with higher frequency on motif positions that involved generalism (i.e. lower specificity values) while the rest of taxonomic groups (non-syrphid Diptera, syrphids, Lepidoptera, Coleoptera and non-bee Hymenoptera) showed the opposite trend with higher frequency on motif positions that implied a greater level of specialization (**Figure S5 A**). Although plants did not have as marked trends as floral visitors, all plant groups showed a slight tendency for generalism (**Figure S5 B**). Second, regarding the number of indirect interactions, bees and tall plants with unisexual flowers showed greater frequency on motif positions that involve low number of indirect interactions (**Figure S6 and Figure S7**). The rest of floral visitor groups showed the opposite tendency and had higher frequencies on motif positions with high number of indirect interactions (**Figure S6**). The rest of plant groups did not show major differences on their frequencies on motifs that implied different number of indirect interactions (**Figure S7**).
