...
Although past studies have evaluated the ecological implications of motifs [@stouffer2012; @simmons2019], motifs are abstract representations often decoupled from species ecology. Species with different reproductive strategies may occupy different positions and be represented in different motifs. At the micro-scale, @tur2013 have linked the degree of pollinator dependence with specialization. However, meso-scale studies have not evaluated the implications and potential of considering the species reproductive strategy.
