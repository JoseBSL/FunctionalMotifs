...
To investigate the structure of the meso-scale in plant-pollinator networks, we have gathered 60 published plant-pollinator networks with worldwide distribution. Then, we have divided the plant and floral visitor species from these networks into groups that summarize their main life-history strategies. After, we calculated the normalize motif frequencies and investigated if these frequencies are similar to the ones expected by chance with thelp of null models. Then, we have also calculated the normalize group frequencies for the different motif positions and investigated also over- and under-representation of the group frequencies.

: (i) gathered 60 published plant-pollinator networks with worldwide distribution; (ii) determined the main plant and floral visitor groups that summarize the principal life-history strategies of the species in these networks; (iii) calculated the normalized motif frequencies and compare them with the expected frequencies from null models from the same set of plant-pollinator networks; (iv) calculated the normalise frequencies of the different plant and floral visitor groups and compare them with the ones from null models; (v) explore the association 

the structure of the meso-scale of plant-pollinator networks we have gathered 60 networks with worldwide distribution. Then, we have determined for the different plant and floral visitor the main groups that define the principal life-history strategies. After, we have calculated the normalize motif frequencies in this same set of plant-pollinator networks and investigated if the overall motif frequencies concur or not with the expected frequencies from null models originated from the same set of networks. Then, 

After, we have calculated the frequencies of the different plant and floral visitor groups and explore if these frequencies also match the expected from null models or not. Finally, we investigate if the plant and floral visitor motif combinations can be retrieve from their expected probability or not by assuming 
