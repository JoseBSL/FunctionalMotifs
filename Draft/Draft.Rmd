...
Research on the network topology of plant-pollinator networks have proven common invariant structural properties across networks. Mutualistic networks tend to be nested [@bascompte2003] and the degree distribution (number of links per species) generally follows a truncated power law distribution [@jordano2003]. Thus, these different properties can be linked to function and help our understanding of the determinants of biodiversity [@bastolla2009]. At the species level, species phenology, abundances and morphological matching have progressed knowledge of our understanding of species interactions (REFs). However, these approaches does not account for indirect interactions (i.e., competitive or facilitative interactions for pollinators).



both macro and micro scale approaches does not account for indirect interactions. The study 




little is known about of indirect interactions 




the ecological analysis of network structure or species interactions involves the use of indices that discard indirect interactions. For instance, considering indirect interactions can provide additional information of the competitive effects or facilittative that plants exert on others 
...
In addition, at the species level we have progressed our understanding of pairwise interactions. Phenological mismacthes 



the study of the microstructure of mutualistic networks have progressed the understanding of pairwise interactions (e.g., trait matching).
