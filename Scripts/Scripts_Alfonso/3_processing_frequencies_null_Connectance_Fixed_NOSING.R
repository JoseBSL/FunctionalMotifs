...
folder_motif_data <- "Data/Csv/Motifs_frequencies_and_null_models_NOSING"

motif_files <- list.files(folder_motif_data) 
motif_freq_files <-  motif_files[grep("Binary_Mat_Sp_Motifs_frequencies_null_Conn_FiX_NOSING_",
                                      motif_files)]
...
for(i in 1:length(motif_freq_files)){
  ...
  new_file_i <- paste0(folder_motif_data, "/Motif_quantiles_Conn_Fixed_NOSING_", network_i,".csv")
...
motif_files <- list.files(folder_motif_data) 
quant_link_files <-  motif_files[grep("Motif_quantiles_Conn_Fixed_NOSING_",motif_files)]
...
final_file_i <- paste0(folder_motif_data, "/Motifs_frequency_percentile_NOSING.csv")
