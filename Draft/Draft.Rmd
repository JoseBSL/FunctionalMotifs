...
The interaction between plants and pollinators can be studied at different scales, from species level interactions (micro-scale) to the full network structure (macro-scale). However, condensing to species level and the holistic view of the full network involves missing relevant information for the understanding of ecological processes [@delmas2019; @simmons2019]. Intermediate levels that investigate plant-pollinator networks (meso-scale) have been little explored but can shed light of ecological processes not captured by the traditional approaches used in plant-pollinator network studies. 

Several studies have evaluated the structure of plant-pollinator interactions. These studies have found common structural properties across networks that can help the understanding of the determinats of biodiversity [@bastolla2009]. One of the major findings is the nested structure of mutualistic networks [@bascompte2003] which describes the topological structure where the specialist interact with subgroups of the interacting species of the generalist. Further, the degree distribution (number of links per species) of plant-pollinator networks have been shown to generally follow a power-law truncated distribution [@jordano2003]. Moreover, at the species level ...
