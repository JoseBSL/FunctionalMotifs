...
The observed functional group probabilities on the different motif positions (**Figure 4**) were insufficient to predict most of the observed network motifs (**Figure 5**). This implies that not just the representation of network motifs types but also the identity of the elements of their structure is influenced by ecological processes that determine under- and over-representation of the different motif combinations. As suggested by @simmons2020, exploring the proportion of these realized network motifs that is competitive or facilitative is a necessary next step to improve our understanding of the architecture of biodiversity [@bascompte2007]. In addition, we found that just 30% of the possible 5,3250 motif combinations took place. This concurs well with the general idea that plant-pollinator networks have a high porportion of non-realized interactions [@jordano2003; @bascompte2013] which can be also infered to indirect interactions. @olesen2011 also found a similar porportion of non-realized links in comparison with our findings of non-realized indirect interactions (80% and 70%, respectively). Some of this non-observed interactions are propably caused by under-sampling [@olesen2011; @jordano2016]. However, a large portion of the possible interactions do not take place because of life history constraints [i.e., forbidden links; @olesen2011; @bartomeus2016; @jordano2016]. Thus, similarly to the presence of forbidden links at the network level, we also found the existence of forbidden motifs that represented almost two thirds of the total combinations of indirect interactions.

I NEED A LAST PHRASE HERE

Despite the recent efforts in understanding what are the main drivers of plant-pollinator interactions that ultimately shape competitive and facilitative processes, we lack comprehensive understanding of how these processes affect species direct and ultimately indirect interactions at a macroecological scale.
